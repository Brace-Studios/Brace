...
import dev.dubhe.brace.utils.Util;
...
public class Commands {
    ...
    public void load() {
        LOGGER.info(new TranslatableComponent("brace.commands.loading").getString());
        HelpCommand.register(this.dispatcher);
        BraceServer.getEventManager().release(CommandRegisterEvent.class, new CommandRegisterEvent(this.dispatcher));
    ...
    public int performCommand(CommandSourceStack source, String command) {
        ...
        try {
            ...
            if (e.getInput() != null && e.getCursor() >= 0) {
                ...
                mutableComponent.append((new TranslatableComponent("brace.commands.context.here")));
            ...
            source.sendFailure((new TranslatableComponent("brace.commands.failed")));
